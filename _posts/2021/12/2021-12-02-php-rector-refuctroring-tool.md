...
![Ректор Мэм](/images/2021/10/rector-mem.jpg)
...
* [Что такое Rector](#что-токое-ректор)
* [Выводы](#выводы)
...
RemoveUnusedPrivateMethod удаляет нужные методы, у нас был яркий конфликт, когда я применил эти правила и не просмотрел код. Это скрипт, который ретко запускался, но разработчик раскоментировал строки по одной и для него это выглядело нормально.
...
Ректор достаточно быстро изменяется, буквально месяц назад правило RemoveUnusedNonEmptyArrayBeforeForeachRector не работало правильно. 
