...
18 апреля выступил на Krasnodar PHP Meetup с докладом «Промпт не поможет. Как жить с ИИ». Здесь — не пересказ, а то, что в 40 минут пришлось сжать или вырезать. Доклад с самого начала был не про промпт-инжиниринг, а про **инженерную культуру**, которая никуда не делась, а только стала важнее.
