...
> Можно пойти дальше: https://psalm.dev/r/ba6ecbd7ba. Актуально, если $this->latest['timestamp'] будет использоваться где-то в коде класса, чтобы не городить приватный геттер с проверками